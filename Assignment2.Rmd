...
plot(posterior) # DO A PRETTY GGPLOT
...
for (t in d$Teacher) {
  ...
  plot_norm = ggplot(Data,aes(grid,posterior_norm))+  
    geom_point()+geom_line()+theme_classic()+  
    geom_line(aes(grid,prior_norm/dens),color='red')+  
    xlab(paste("Knowledge of", t))+ 
    ylab("posterior probability")
  
  plot_flat = ggplot(Data,aes(grid,posterior_flat))+  
    geom_point()+geom_line()+theme_classic()+  
    geom_line(aes(grid,prior_flat/dens),color='red')+  
    xlab(paste("Knowledge of", t))+ 
    ylab("posterior probability")
